...
<form action="{{ route('register') }}" method="post" enctype="multipart/form-data">
        ...
        <div class="col-sm-9">
            ...
            <select name="gender_id" id="gender_id" class="form-control select2 select2-success{{ $errors->has('gender_id') ? ' is-invalid' : '' }}" data-dropdown-css-class="select2-success" required>
                @foreach ($genders->getAll() as $collection)
                    <option value="{{ $collection->getKey() }}"{{ old('gender_id', $collection->gender_id) === $collection->getKey() ? ' selected' : '' }}>{{ $collection->name }}</option>
                @endforeach
            </select>
        ...
        <div class="col-sm-9">
            ...
            <select name="department_id" id="department_id" class="form-control select2 select2-success{{ $errors->has('department_id') ? ' is-invalid' : '' }}" data-dropdown-css-class="select2-success" required>
                @foreach ($departments->getAll() as $collection)
                    <option value="{{ $collection->getKey() }}"{{ old('department_id', $collection->department_id) === $collection->getKey() ? ' selected' : '' }}>{{ $collection->name }}</option>
                @endforeach
            </select>
        ...
        <div class="col-sm-9">
            ...
            <select name="degree_id" id="degree_id" class="form-control select2 select2-success{{ $errors->has('degree_id') ? ' is-invalid' : '' }}" data-dropdown-css-class="select2-success" required>
                @foreach ($degrees->getAll() as $collection)
                    <option value="{{ $collection->getKey() }}"{{ old('degree_id', $collection->degree_id) === $collection->getKey() ? ' selected' : '' }}>{{ $collection->name }}</option>
                @endforeach
            </select>
        ...
        <div class="col-sm-9">
            ...
            <select name="title_id" id="title_id" class="form-control select2 select2-success{{ $errors->has('title_id') ? ' is-invalid' : '' }}" data-dropdown-css-class="select2-success" required>
                @foreach ($titles->getAll() as $collection)
                    <option value="{{ $collection->getKey() }}"{{ old('title_id', $collection->title_id) === $collection->getKey() ? ' selected' : '' }}>{{ $collection->name }}</option>
                @endforeach
            </select>
        ...
        <div class="col-sm-9">
            ...
            <select name="applied_title_id" id="applied_title_id" class="form-control select2 select2-success{{ $errors->has('applied_title_id') ? ' is-invalid' : '' }}" data-dropdown-css-class="select2-success" required>
                @foreach ($appliedTitles->getAppliedTitles() as $collection)
                    <option value="{{ $collection->getKey() }}"{{ old('applied_title_id', $collection->applied_title_id) === $collection->getKey() ? ' selected' : '' }}>{{ $collection->name }}</option>
                @endforeach
            </select>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            <div class="icheck-success icheck-inline">
                <input type="radio" name="has_course" id="has_course1" class="form-check-input{{ $errors->has('has_course') ? ' is-invalid' : '' }}" value="1"{{ old('has_course', $collection->has_course) == '1' ? ' checked' : '' }}>
                <label class="form-check-label" for="has_course1">是</label>
            </div>
            <div class="icheck-success icheck-inline">
                <input type="radio" name="has_course" id="has_course0" class="form-check-input{{ $errors->has('has_course') ? ' is-invalid' : '' }}" value="0"{{ old('has_course', $collection->has_course) == '0' ? ' checked' : '' }}>
    ...
    <div class="form-group row">
        ...
        <div class="col-sm-9">
            <div class="icheck-success icheck-inline">
                <input type="radio" name="is_applied_expert" id="is_applied_expert1" class="form-check-input{{ $errors->has('is_applied_expert') ? ' is-invalid' : '' }}" value="1"{{ old('is_applied_expert', $collection->is_applied_expert) == '1' ? ' checked' : '' }}>
                <label class="form-check-label" for="is_applied_expert1">是</label>
            </div>
            <div class="icheck-success icheck-inline">
                <input type="radio" name="is_applied_expert" id="is_applied_expert0" class="form-check-input{{ $errors->has('is_applied_expert') ? ' is-invalid' : '' }}" value="0"{{ old('is_applied_expert', $collection->is_applied_expert) == '0' ? ' checked' : '' }}>
    ...
    <div class="form-group row" id="block-reason">
        ...
        <div class="col-sm-9">
            <select name="reason" id="reason" class="form-control select2 select2-success{{ $errors->has('reason') ? ' is-invalid' : '' }}" data-dropdown-css-class="select2-success">
                <option value="1"{{ old('reason', $collection->reason) === '1' ? ' selected' : '' }}>{{ config('setting.reason.1') }}</option>
                <option value="2"{{ old('reason', $collection->reason) === '2' ? ' selected' : '' }}>{{ config('setting.reason.2') }}</option>
            </select>
