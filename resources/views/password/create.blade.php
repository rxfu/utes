		    ...
		    <form role="form" id="create-form" name="create-form" method="post" action="{{ route('passwords.store') }}">
                ...
                <div class="card-body">
	                <div class="form-group row">
	                    ...
	                    <div class="col-md-9">
	                    	<input type="password" name="old_password" id="old_password" class="form-control{{ $errors->has('old_password') ? ' is-invalid' : '' }}" placeholder="{{ __('password.old_password') }}" value="{{ old('old_password') }}" required focus>
	                ...
	                <div class="form-group row">
	                    ...
	                    <div class="col-md-9">
	                    	<input type="password" name="password" id="password" class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" placeholder="{{ __('password.password') }}" required>
	                ...
	                <div class="form-group row">
	                    ...
	                    <div class="col-md-9">
	                    	<input type="password" name="password_confirmation" id="password_confirmation" class="form-control{{ $errors->has('password_confirmation') ? ' is-invalid' : '' }}" placeholder="{{ __('password.password_confirmation') }}" required>
