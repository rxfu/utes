...
@section('title', __('Create') . __('score.module'))
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">{{ __('Create') . __('score.module') }}</h3>
            </div>

		    <form role="form" id="create-form" name="create-form" method="post" action="{{ route('scores.store') }}">
                @csrf
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control{{ $errors->has('student1') ? ' is-invalid' : '' }}" name="student1" id="student1" placeholder="{{ __('score.student1') }}" value="{{ old('student1') }}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control{{ $errors->has('plan1') ? ' is-invalid' : '' }}" name="plan1" id="plan1" placeholder="{{ __('score.plan1') }}" value="{{ old('plan1') }}">
                            @if ($errors->has('plan1'))
                                <div class="invalid-feedback" role="alert">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control{{ $errors->has('plan2') ? ' is-invalid' : '' }}" name="plan2" id="plan2" placeholder="{{ __('score.plan2') }}" value="{{ old('plan2') }}">
                            @if ($errors->has('plan2'))
                                <div class="invalid-feedback" role="alert">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control{{ $errors->has('peer1') ? ' is-invalid' : '' }}" name="peer1" id="peer1" placeholder="{{ __('score.peer1') }}" value="{{ old('peer1') }}">
                            @if ($errors->has('peer1'))
                                <div class="invalid-feedback" role="alert">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control{{ $errors->has('peer2') ? ' is-invalid' : '' }}" name="peer2" id="peer2" placeholder="{{ __('score.peer2') }}" value="{{ old('peer2') }}">
                            @if ($errors->has('peer2'))
                                <div class="invalid-feedback" role="alert">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control{{ $errors->has('peer3') ? ' is-invalid' : '' }}" name="peer3" id="peer3" placeholder="{{ __('score.peer3') }}" value="{{ old('peer3') }}">
                            @if ($errors->has('peer3'))
                                <div class="invalid-feedback" role="alert">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control{{ $errors->has('expert1') ? ' is-invalid' : '' }}" name="expert1" id="expert1" placeholder="{{ __('score.expert1') }}" value="{{ old('expert1') }}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control{{ $errors->has('expert2') ? ' is-invalid' : '' }}" name="expert2" id="expert2" placeholder="{{ __('score.expert2') }}" value="{{ old('expert2') }}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control{{ $errors->has('expert3') ? ' is-invalid' : '' }}" name="expert3" id="expert3" placeholder="{{ __('score.expert3') }}" value="{{ old('expert3') }}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control{{ $errors->has('expert4') ? ' is-invalid' : '' }}" name="expert4" id="expert4" placeholder="{{ __('score.expert4') }}" value="{{ old('expert4') }}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control{{ $errors->has('expert5') ? ' is-invalid' : '' }}" name="expert5" id="expert5" placeholder="{{ __('score.expert5') }}" value="{{ old('expert5') }}">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <textarea class="form-control{{ $errors->has('remark') ? ' is-invalid' : '' }}" name="remark" id="remark" rows="5" placeholder="{{ __('score.remark') }}">{{ old('remark') }}</textarea>
