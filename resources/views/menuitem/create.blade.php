		    ...
		    <form role="form" id="create-form" name="create-form" method="post" action="{{ route('menuitems.store') }}">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control{{ $errors->has('slug') ? ' is_invalid' : '' }}" name="slug" id="slug" placeholder="{{ __('menuitem.slug') }}" value="{{ old('slug') }}">
                            @if ($errors->has('slug'))
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
							...
							<select name="parent_id" id="parent_id" class="form-control select2 select2-success{{ $errors->has('parent_id') ? ' is_invalid' : '' }}" data-dropdown-css-class="select2-success">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
							...
							<select name="menu_id" id="menu_id" class="form-control select2 select2-success{{ $errors->has('menu_id') ? ' is_invalid' : '' }}" data-dropdown-css-class="select2-success">
