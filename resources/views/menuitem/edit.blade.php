    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">编辑{{ __('menuitem.module') }}{{ $item->id }}</h3>
            </div>
		    ...
		    <form role="form" id="edit-form" name="edit-form" method="post" action="{{ route('menuitems.update', $item->getKey()) }}">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <div class="form-check form-check-inline">
                                <input type="radio" name="forbidden_delete" id="forbidden_delete" class="form-check-input{{ $errors->has('forbidden_delete') ? ' is_invalid' : '' }}" value="1"{{ old('forbidden_delete', $item->forbidden_delete) === 1 ? ' checked' : '' }}>
                                <label class="form-check-label" for="forbidden_delete1">是</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input type="radio" name="forbidden_delete" id="forbidden_delete0" class="form-check-input{{ $errors->has('forbidden_delete') ? ' is_invalid' : '' }}" value="0"{{ old('forbidden_delete', $item->forbidden_delete) === 0 ? ' checked' : '' }}>
