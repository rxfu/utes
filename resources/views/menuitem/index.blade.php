                    ...
                    <tbody>
                        @foreach ($items as $item)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('menuitems.show', $item) }}" class="btn btn-primary btn-sm" title="显示">
                                        <i class="fas fa-folder"></i> 显示
                                    </a>
                                    @unless($item->is_system)
                                        <a href="{{ route('menuitems.edit', $item) }}" class="btn btn-info btn-sm" title="编辑">
                                            <i class="fas fa-pencil-alt"></i> 编辑
                                        </a>
                                        <a href="{{ route('menuitems.destroy', $item) }}" class="btn btn-danger btn-sm delete" title="删除" data-toggle="modal" data-target="#dialog" data-whatever="确认删除">
