		    ...
		    <form role="form" id="edit-form" name="edit-form" method="post" action="{{ route('settings.update', $item) }}">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" id="name" placeholder="{{ __('setting.name') }}" value="{{ old('name', $item->name) }}">
                            @if ($errors->has('name'))
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control{{ $errors->has('value') ? ' is-invalid' : '' }}" name="value" id="value" placeholder="{{ __('setting.value') }}" value="{{ old('value', $item->value) }}">
                            @if ($errors->has('value'))
                                <div class="invalid-feedback" role="alert">
