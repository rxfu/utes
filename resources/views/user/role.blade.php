...
<div class="row">
    <div class="col-12">
        <div class="card">
		    ...
		    <form role="form" id="grant-form" name="grant-form" method="post" action="{{ route('users.grant', $item->getKey()) }}">
                @csrf
                <div class="card-body">
                    
                    <div class="form-group row">
                        <label for="username" class="col-sm-3 col-form-label text-right">{{ __('role.module') }}</label>
                        <div class="col-sm-9">
